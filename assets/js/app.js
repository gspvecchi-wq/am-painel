...
async function carregarAcionamentos() {
  ...
  try {
    ...
    let statsHtml = `<div class="cs-stat-card cs-stat-acc card-spotlight"><div class="cs-stat-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg></div><div class="cs-stat-num">${registros.length}</div><div class="cs-stat-lbl">Total acionamentos</div></div>`;
